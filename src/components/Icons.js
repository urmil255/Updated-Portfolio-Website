...
export const CircularText = ({ className, ...rest }) => (
  ...
  >
    ...
    <circle cx="248" cy="248" r="200" fill="none" stroke="none" />
    <text fill="currentColor" fontSize="35" fontWeight="bold">
      <textPath href="#circlePath" startOffset="40%" textAnchor="middle">
